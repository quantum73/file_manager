...
<br>Нажатие кнопки <b>Create</b> создаёт данную папку.
...
- Поддерживаемые расширения файлов: ```.obj, .zip, .rar, .blend, .fbx```
...
В поле поиска <b>Search Tag/Description</b> вводится название тэга или часть описания, в зависимости от того, что вы
<br>хотите найти. Кнопка <b>Tag</b> выполняет поиск по тэгу(название папки), а кнопка <b>Description</b> выполняет поиск
<br>по описанию, соответственно.
...
<img src="presentation/buffer_link.png" width="300"/>

Чтобы добавить модель в виде ссылки на Buffer введите в поле <b>Buffer link</b> ссылку на файл в Buffer и нажмите <b>Add link</b>
...
<br>Изначально, при загрузке, у модели нет описания и описание заполняется фразой <i>no_desc</i>:
...
Поддерживаемые расширения изображений: ```.png, .jpg, .jpeg, .bmp```
